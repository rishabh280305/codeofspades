...
type ReceptionHistoryPageProps = {
...
export default async function ReceptionHistoryPage({ searchParams }: ReceptionHistoryPageProps) {
        ...
        <div className="mt-4 space-y-3">
          ...
          {history.map((appointment) => (
            <article key={String(appointment._id)} className="border-2 border-black bg-[var(--panel)] p-3">
              ...
              <p className="text-sm">Doctor: {appointment.doctorId?.name || "N/A"}</p>
